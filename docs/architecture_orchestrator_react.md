...
flowchart TD
    ...
    NoCalls -- no --> Normalize --> Invalid --> Req --> PhasePlan --> MutVerifyGate --> MutContinue --> MutResult --> GuideProg --> PhaseProg --> Guide --> GuideGate --> Enforce --> Final --> Next --> Target --> AssistantTools --> Analyze
    Analyze --> Interactive
